...
#ifdef TEST_DOUBLE
	spgpuDellspmv (spgpuHandle, devZ, devY, ALPHA, devCm, devRp, ellPitch, ellPitch, NULL, NULL, ellMaxRowSize, ellMaxRowSize, rowsCount, devX, BETA, 0);
#else
	spgpuSellspmv (spgpuHandle, devZ, devY, (float)ALPHA, devCm, devRp, ellPitch, ellPitch, NULL, NULL, ellMaxRowSize, ellMaxRowSize, rowsCount, devX, (float)BETA, 0);
#endif
